        ...
        <div className="max-w-6xl mx-auto py-14 px-6">
          ...
          >
            ...
            <div className="md:w-1/2 text-center md:text-right">
              ...
              <p className="text-lg text-gray-700 leading-relaxed">
                Dhruv Datta is an engineer by academics and a businessman at heart, combining technical skills with an entrepreneurial mindset. Dhruv takes pride in the rigor of his equity research driven approach to the markets and is leading the development of quantitative models to find an edge. He is the Co-CIO of Maroon Fund (a $70,000 long only fund) at Texas A&M and Co-Founded Scholars of Finance alongside Bhuvan. He has extensive engineering experience, including work in 3 research laboratories and 4 internships (at companies like NASA and GE Vernova). Dhruv architected the firm’s entire operational backbone from the ground up, establishing the legal frameworks and accounting infrastructure necessary to support institutional grade scaling.
              </p>
            </div>
          </motion.div>
        </div>
