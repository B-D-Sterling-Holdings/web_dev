  ...
  return (
    <main className="min-h-screen bg-[#fafafa] text-black overflow-hidden">
      ...
      <div className="fixed inset-0 overflow-hidden pointer-events-none">
        ...
        <div className="absolute top-0 right-0 w-[800px] h-[800px] bg-gradient-to-bl from-cyan-200/30 via-transparent to-transparent rounded-full blur-3xl opacity-35" />
      </div>
