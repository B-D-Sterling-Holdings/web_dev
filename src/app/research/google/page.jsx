      ...
      <div className="relative z-10">
          ...
          <div className="max-w-7xl mx-auto">
            ...
            >
              <div className="flex items-center gap-6">
                <div className="w-20 h-20 bg-white rounded-2xl shadow-lg border border-gray-100 flex items-center justify-center p-4">
                  <img src="/google.jpg" alt="Google logo" className="w-full h-full object-contain" />
                </div>
                <div>
                  <div className="flex items-center gap-3 mb-2">
                    <h1 className="text-4xl lg:text-5xl font-bold text-gray-900">Google</h1>
                    <span className="px-3 py-1 bg-emerald-50 text-emerald-700 text-sm font-semibold rounded-full border border-emerald-200">
                      GOOGL
                    </span>
                  </div>
                  <p className="text-gray-600">Alphabet Inc. - Equity Research Report</p>
                </div>
              </div>

              <div className="flex flex-wrap gap-3">
                {['Search Dominance', 'Cloud Growth', 'AI Leadership'].map((tag, i) => (
                  <span
                    key={i}
        ...
        <section className="py-8 px-6 lg:px-12">
          <div className="max-w-7xl mx-auto">
            ...
            >
              {[
                { icon: TrendingUp, label: 'Investment Thesis', value: 'Quality at Dislocation' },
                { icon: BarChart3, label: 'Key Driver', value: 'AI & Cloud Growth' },
                { icon: Target, label: 'Catalyst', value: 'Waymo Monetization' },
              ].map((metric, i) => (
            ...
            >
              <div className="p-6 border-b border-gray-100">
                <div className="flex items-center justify-between">
                  ...
                  <a
                    href="https://docs.google.com/presentation/d/e/2PACX-1vQdOpAsT5tgAOufY22keF0by1LFKutduj_lRINUmQwiKdcoovrL8fcS89DzAULlOzt4u7N3QS3kU7E4/pubembed"
                    target="_blank"
              ...
              <div className="aspect-video w-full">
                <iframe
                  src="https://docs.google.com/presentation/d/e/2PACX-1vQdOpAsT5tgAOufY22keF0by1LFKutduj_lRINUmQwiKdcoovrL8fcS89DzAULlOzt4u7N3QS3kU7E4/pubembed?start=false&loop=false&delayms=3000"
                  width="100%"
                  height="100%"
                  allowFullScreen
                  className="border-0"
